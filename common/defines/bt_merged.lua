...
NDefines.NAI.DIPLOMATIC_INTEREST_DISTANCE = 200 -- BT added to make ai better with alliances and wars Harbivore
...
NDefines.NAI.FORT_CAPITAL_DESIRE = 1  -- Increased in bt to make smarter ai and also because of the amount of provinces some nations are much easier to walk onto their capital. Harbivore
