...
NDefines.NAI.MINIMUM_STRENGTH_TO_AVOID_UNCONDITIONAL_SURRENDER = 10 -- BT decreased to hopefully have ai chose to lose this to win another day Harbivore
NDefines.NAI.MISSIONARY_MAINTENANCE_SHARE = 0.1 -- BT changed from 0.2 to make ai make better choices
NDefines.NAI.UNCONDITIONAL_SURRENDER_HOPELESS_STRENGTH_COMPARISON = 10 -- BT decreased to hopefully have ai chose to lose this to win another day Harbivore
NDefines.NAI.UNCONDITIONAL_SURRENDER_WARSCORE_LIMIT = -70 -- BT decreased to hopefully have ai chose to lose this to win another day Harbivore
...
NDefines.NCountry.INNOVATIVENESS_BEHIND_IN_TECH_PENALTY = -0.03			-- BTAddOn changed from 0p03 Trying to make being ahead of time somewhat more useful
...
NDefines.NCountry.INNOVATIVENESS_FIRST_REACHED_TECH_LEVEL = 4.0			-- BTAddOn changed from 2p0 Trying to make being ahead of time somewhat more useful. Vanilla buffed it following their lead.
